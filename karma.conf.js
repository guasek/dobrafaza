...
module.exports = function(config) {
  config.set({
    ...
    files: [
      ...
      'app/scripts/notifications/mobile_menu.js',
      'app/scripts/notifications/notifications_service.js',
      'app/scripts/notifications/like_notification_subscriber.js',
      'app/scripts/notifications/notifications_module.js',
      'app/scripts/*.js',
      'app/scripts/**/*.js',
